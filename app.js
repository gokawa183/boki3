...
const STUDY_LK_ORDER=['basics','shiwake','kamoku','deposit','cashcontent','koguchi','kakeuri','tegata','kitte','kotei','yuka','mibarai','maebara','soukanjo','hojobo','chosahyo','seizan','bspl','kessanuri'];
