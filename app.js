...
const LEDGER_PROBLEMS=[
  ...
  {title:'前払費用の次月繰越（複数科目）',account:'前払費用',
   desc:'決算整理で支払保険料のうち40,000円・支払家賃のうち30,000円が翌期分として前払費用に計上されました。\n次月繰越を求めなさい。（資産→借方残高のため、次月繰越は貸方側に記入）',
   debits: [{label:'支払保険料',amount:40000},{label:'支払家賃',amount:30000}],
   credits:[{label:'次月繰越',amount:null}],
   answer:70000,
   exp:'借方合計 (40,000＋30,000)＝<strong>70,000円</strong><br>前払費用は資産科目（借方残高）のため、次月繰越は貸方側に記入します。'},
  {title:'未払費用の次月繰越（複数科目）',account:'未払費用',
   desc:'期末決算で給料の未払分55,000円・支払利息の未払分15,000円を未払費用として計上しました。\n次月繰越を求めなさい。（負債→貸方残高のため、次月繰越は借方側に記入）',
   debits: [{label:'次月繰越',amount:null}],
   credits:[{label:'給料（未払分）',amount:55000},{label:'支払利息（未払分）',amount:15000}],
   answer:70000,
   exp:'貸方合計 (55,000＋15,000)＝<strong>70,000円</strong><br>未払費用は負債科目（貸方残高）のため、次月繰越は借方側に記入します。'},
  {title:'未収収益の次月繰越',account:'未収収益',
   desc:'期末決算で受取利息の未収分18,000円・受取手数料の未収分12,000円を未収収益として計上しました。\n次月繰越を求めなさい。（資産→借方残高のため、次月繰越は貸方側に記入）',
   debits: [{label:'受取利息（未収分）',amount:18000},{label:'受取手数料（未収分）',amount:12000}],
   credits:[{label:'次月繰越',amount:null}],
   answer:30000,
   exp:'借方合計 (18,000＋12,000)＝<strong>30,000円</strong><br>未収収益は資産科目（借方残高）のため、次月繰越は貸方側に記入します。'},
  {title:'繰越利益剰余金の次月繰越',account:'繰越利益剰余金',
   desc:'当期純利益を損益勘定から繰越利益剰余金へ振り替えました。\n次の勘定をもとに次月繰越を求めなさい。（純資産→貸方残高）',
   debits: [{label:'次月繰越',amount:null}],
   credits:[{label:'前月繰越',amount:350000},{label:'損益（当期純利益）',amount:90000}],
   answer:440000,
   exp:'貸方合計 (350,000＋90,000)＝<strong>440,000円</strong><br>繰越利益剰余金は純資産（貸方残高）のため、次月繰越は借方側に記入します。'},
