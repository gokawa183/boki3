...
async function init(){
  // まず全タブを確実にhiddenにする
  ['quiz','stats','study','exam','mock','q2study','q3study','reference']
    .forEach(t => {
...
function showTab(tab,el){
  ['quiz','stats','study','exam','mock','q2study','q3study','reference','ledger','release'].forEach(t=>document.getElementById('tab-'+t).classList.add('hidden'));
